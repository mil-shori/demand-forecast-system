...
from app.database import get_db, DatabaseHealthCheck
...
async def database_health_check():
    ...
    return {
        "status": "healthy" if (
            connection_check["status"] == "healthy" and 
            tables_check["status"] == "healthy"
        ) else "unhealthy",
        "timestamp": datetime.utcnow().isoformat(),
...
def check_configuration() -> dict:
    ...
    try:
        ...
        return {
            ...
            "message": "Configuration is valid" if not issues else "Configuration issues found",
